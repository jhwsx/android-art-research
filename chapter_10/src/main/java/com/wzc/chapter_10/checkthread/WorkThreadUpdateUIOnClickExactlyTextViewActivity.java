...
public class WorkThreadUpdateUIOnClickExactlyTextViewActivity extends Activity {
    private TextView tv;
    @Override
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, WorkThreadUpdateUIOnClickExactlyTextViewActivity.class);
