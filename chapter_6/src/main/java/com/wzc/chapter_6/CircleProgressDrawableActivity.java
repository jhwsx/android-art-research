 ...
 * @date 2018/10/22
 */
public class CircleProgressDrawableActivity extends Activity {


    public static void start(Context context) {
        Intent starter = new Intent(context, CircleProgressDrawableActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circleprogressdrawable);
    }
